...
class AccountingDiary extends _react.default.Component {
  ...
  render() {
    ...
    }, "Accounting diary for ", this.props.title), this.getArray(context.state.data).map((elt, i) => /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Header.default, {
      date: elt.date,
      index: i,
      account: this.props.account,
      amount: this.props.amount
    }), _lodash.default.orderBy(elt.content, 'isDebit', "desc").map(row => /*#__PURE__*/_react.default.createElement(_Content.default, {
      value: row,
      account: this.props.account,
      amount: this.props.amount
