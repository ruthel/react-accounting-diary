...
class AccountingDiary extends _react.default.Component {
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement(_context.GlobalProvider, null, /*#__PURE__*/_react.default.createElement(_context.GlobalContext.Consumer, null, context => /*#__PURE__*/_react.default.createElement("div", {
      ...
      value: "toPng"
    }, "PNG")), /*#__PURE__*/_react.default.createElement("div", {
      id: "diary",
      style: {
        padding: 8
      }
      ...
      style: {
        ...
        border: "".concat(this.props.titleBorder ? '1px' : '0', " solid rgba(0,0,0,.1)"),
        background: this.props.titleBg,
        textTransform: this.props.titleAllCaps ? 'uppercase' : '',
        borderRadius: this.props.titleCorner
      }
    }, "Accounting diary for ", this.props.title), this.getArray(context.state.data || this.props.data).map((elt, i, array) => /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Header.default, {
      date: elt.date,
      columnHeader: this.props.columnHeader,
      columnHeaderColor: this.props.columnHeaderColor,
      columnHeaderBgColor: this.props.columnHeaderBgColor,
      index: i,
      account: this.props.account,
      amount: this.props.amount
    }), _lodash.default.orderBy(elt.content, 'isDebit', "asc").map((row, i) => /*#__PURE__*/_react.default.createElement(_Content.default, {
      value: row,
      length: array.length,
      account: this.props.account,
      amount: this.props.amount
