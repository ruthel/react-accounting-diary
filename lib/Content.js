...
class Content extends _react.default.Component {
  render() {
    ...
    }, /*#__PURE__*/_react.default.createElement("div", null, value.isDebit ? _func.default.currency(value.amount) : '')), /*#__PURE__*/_react.default.createElement("div", {
      className: "amount-credit flex-col",
      style: this.props.amount
    }, /*#__PURE__*/_react.default.createElement("div", null, !value.isDebit ? _func.default.currency(value.amount) : '')));
  }
